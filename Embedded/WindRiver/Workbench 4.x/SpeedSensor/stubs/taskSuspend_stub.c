...
/** User stub definition for function: STATUS taskSuspend(TASK_ID) */
EXTERN_C_LINKAGE STATUS taskSuspend (TASK_ID tid) ;
EXTERN_C_LINKAGE STATUS CppTest_Stub_taskSuspend (TASK_ID tid) 
{
    return 0;
}
