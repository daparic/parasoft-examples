...
/** User stub definition for function: void printSpeed(double, double, double) */
EXTERN_C_LINKAGE void printSpeed (double mps, double mph, double kmph) ;
EXTERN_C_LINKAGE void CppTest_Stub_printSpeed (double mps, double mph, double kmph) 
{
	/* Escape infinite loop in displaySpeed task */
	CPPTEST_JMP(1);
	return;
}
